...
export const ACCEPTEDTEMPLATEVARIABLES: Array<string> = [
  "%T",
  "%T",
  "%U",
  "%U",
...
export const ACCEPTEDTEMPLATEVARIABLESSET: Set<string> = new Set(
...
export const stringIndexOf = Function.prototype.call.bind(
...
export const reduceReplace = curry(
  (
    templateFunctions: Record<string, (arg: string | Date) => string>,
...
export const basicCaptureTemplateSubstitution = curry(
  (
    templateVariablesObject: Record<string, (arg: any) => string>,
    customVariablesObject: Record<string, string>,
    templateString: string,
  ): [string, number | null] => {
    return pipe([
      reduceReplace(templateVariablesObject, customVariablesObject, new Date()),
      over([replaceCursor, getCursorIndex]),
    ])(templateString);
  },
);

export const captureTemplateSubstitution = basicCaptureTemplateSubstitution(
