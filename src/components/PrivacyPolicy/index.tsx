...
const PrivacyPolicy = () => {
  return (
    <div className="privacy-policy-container">
      ...
      <p>
        <ExternalLink href="https://200ok.ch/">200ok llc</ExternalLink> operates
        the <ExternalLink href="https://organice.200ok.ch" /> website and mobile
        apps.
      </p>
      ...
      <p>
        ...
        Dropbox will be stored or monitored by our Service. All access to user
        data is done through the proper APIs of the respective services, and all
        data is only processed by the browser. No data will be shared with any
        other service.
      </p>
