...
export default ({
  ...
  return (
    <>
      ...
      Since you last pulled {path}, a newer version of the file has been pushed
      to the server. The newer version is from:
      <br />
      &nbsp;
      <br />
      ...
      <div className="sync-confirmation-modal__buttons-container">
        <button
          className="btn sync-confirmation-modal__button"
          onClick={onPull}
        >
